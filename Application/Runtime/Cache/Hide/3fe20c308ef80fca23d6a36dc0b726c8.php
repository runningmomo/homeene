	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?php echo ($_SESSION['adminInfo']['username']); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><a href="<?php echo U('Home/Index/index');?>"><i class="Hui-iconfont">&#xe625;</i> 前台首页</a></dt>
		</dl>
		<dl id="menu-article">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<?php echo U('Manager/Index');?>" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
