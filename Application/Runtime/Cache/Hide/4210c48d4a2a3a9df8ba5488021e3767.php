...
<div class="page-container">
	<p class="f-20 text-success">欢迎登录美易家后台！</p>
	<p>登录次数：<?php echo ($_SESSION['adminInfo']['login_num']); ?> </p>
	<p>上次登录IP：<?php echo ($_SESSION['adminInfo']['last_ip']); ?>  上次登录时间：<?php echo ($_SESSION['adminInfo']['last_time']); ?></p>
